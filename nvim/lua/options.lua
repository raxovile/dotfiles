...
-- Enables relative line numbers, which are useful for quickly navigating and orienting yourself.
-- The current line is always shown with its absolute number, while other lines are numbered relative to the cursor position.
vim.opt.relativenumber = true
